...
const dreamError = document.getElementById("dream-error-message") as HTMLParagraphElement;
const themeError = document.getElementById("theme-error-message") as HTMLParagraphElement;
